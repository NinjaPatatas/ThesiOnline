...
if (isset($_POST['btncreate'])) {
    if($_POST['password']==$_POST['cpassword']){
        ...
        $sqlfind="select * from userid where username ='".$_POST['uname']."'";
        $resfind=mysqli_query($con,$sqlfind);
        $count=mysqli_num_rows($resfind);
        
        
        if($count==1){
            echo "<script type='text/javascript'>alert('username already in used')</script>";
        }else{
            $sqladd="INSERT into userid (username,displayname,password,role,campus,status) values ('".$_POST['uname']."','".$_POST['fname']."','".$password."','".$_POST['des']."','".$_POST['campus']."','active')";
...
<div class="content-wrapper " >
    ...
    <form action="#" class="signin-form" method="post">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control form-control-border border-width-2" id="fname" placeholder="Firstname MiddleInitial Lastname" name="fname" required>
                  </div>
                  <div class="form-group col-6">
        ...
        <hr>
          ...
          <button name="btncreate" type="submit" class="btn btn-block btn-success col-4" style="background-color: #12543b !Important;">Create new account </button>
